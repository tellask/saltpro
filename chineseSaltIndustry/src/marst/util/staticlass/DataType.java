...
public class DataType {
	...
	public static String toSimpleType(String typeName) {
		...
		typeName = deletePrefix(typeName, "com.dbcom.dataset.");	//加入dataSet函数
		return typeName;
	}
...
//				retObj = new java.sql.Timestamp(date.getTime());
	...
	public static final int DT_DataSet=44;	//dataSet
	...
	static {
		...
		dataTypeMap.put("DataSetImpl", DT_DataSet);	//加入dataSet判断
